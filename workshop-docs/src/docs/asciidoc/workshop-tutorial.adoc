...
For example if you could not manage to complete the tutorial based on **lab-1/initial-library-server**
just continue using **lab-1/complete-library-server**.
====
...
|http://localhost:8080[http://localhost:9092]
|===
...
===== Configure web client authorities
...
===== Change authentication principal
...
* Run _LibraryServerApplication_ class in project *lab-5/complete-resource-server*
* Run _OAuth2LoginClientApplication_ class in project *lab-6/initial-oidc-client*
...
[NOTE]
====
You find the completed code in project *lab-6/complete_oidc_client*.
====
...
image::images/feedback_qr_code_entwicklertag_karlsruhe.jpg[scaledwidth="50%", scaledheight="50%",alt="novatec"]
