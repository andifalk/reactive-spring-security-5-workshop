...
image::images/entwicklertag-karlsruhe.jpeg[scaledwidth="40%", scaledheight="40%",alt="novatec"]
...
[[resource-server]]
=== Lab 1: OpenID Connect Resource Server
