...
* 05-oauth2: This adds an OAuth2 login clientand resource server for interacting with an authorization server for login
...
* https://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#jc-oauth2login[Spring Security OAuth2/OIDC Login Client Reference Documentation]
...
* *initial-library-server*: The reactive version of the library server (same as previous workshop step _04-library-server_)
